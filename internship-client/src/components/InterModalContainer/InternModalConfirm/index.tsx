...
const InternModalConfirm = ({
  headerText = 'XÁC NHẬN NƠI THỰC TẬP',
  children,
  footerModal,
  id,
  isLoading = false,
    ...
    >
      <div className="w-2/4 mx-auto md:h-auto relative">
        ...
        <div className=" bg-white rounded-lg shadow ">
          ...
          <div className="p-6 space-y-6">{'Bạn có muốn xác nhận thực tập ở công ty này ?'}</div>
...
export default InternModalConfirm;
